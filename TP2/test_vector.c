...
int main(){
    ...
    print("insert 9.1 en position 3\n");
    afficheTab(p_s_Vector);


    //pour tester la fonction erase
    print("Ecrasement de la valeur en indice 2 \n");
    afficheTab(p_s_Vector);
    vector_erase(p_s_Vector,2);
    afficheTab(p_s_Vector);

    //tester la fonction push_back
    print("Ajout de 6.0 en fin de tableau\n");
    afficheTab(p_s_Vector);
    vector_push_back(p_s_Vector,6.0);
    afficheTab(p_s_Vector);

    //tester la fonction pop_back
    print("pop de la dernière valeur du tableau\n");
    afficheTab(p_s_Vector);
    ...
    print("Récupération de la valeur en index 2 du tableau et écriture dans le pointeur\n");
    ...
    print("Supprime toutes les valeurs du tableau\n");
    printf("%d\n", p_s_Vector -> size);

    //tester la fonction empty
    print("Retourne 1 si le tableau est vide doit retourner 1\n");
